...
Recently released [CSM 1.6](https://cldr-steven-matison.github.io/blog/Cloudera-Streams-Messaging-Kubernetes-Operator-1.6/) brings Surveyor, Iceberg Connector, and Schema Registry.  In my previous blog post [Schema Registry](https://cldr-steven-matison.github.io/blog/Schema-Registry/), I expose the steps to get to the UI.  Now let's do the same with Surveyor.

First, skip the "hard install" [docs](https://docs.cloudera.com/csm-operator/1.6/installation/topics/csm-op-install-surveyor-overview.html#concept_k1j_x1w_vfc), and work with the basic evaluation [docs](https://docs.cloudera.com/csm-operator/1.6/installation/topics/csm-op-install-surveyor-overview.html#task_gfn_mmj_wfc).  We just want to evaluate that the operator works and that we can get to and see the Surveyor UI.  
