...
excerpt: "A practical roadmap for transforming data from edge devices into real-time AI use cases — architectures, tooling options, and tradeoffs."
header:
...
- Integrate a data in motion architecture
- Apply data governance across the entire data lifecycle

The topics line up directly with the work I do every day — [Cloudera Edge Flow Manager](/blog/Cloudera-Edge-Flow-Manager-on-Kubernetes/), MiNiFi, NiFi, Kafka, Flink, and the AI patterns that sit on top of them — so if any of the recent posts on this blog have caught your eye, this is a great companion read.
